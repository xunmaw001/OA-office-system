...
public class WenjianView extends WenjianEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 文件审批状态的值
		*/
		private String wenjianYesnoValue;
	...
	public WenjianView(WenjianEntity wenjianEntity) {
		try {
			...
			* 获取： 文件审批状态的值
			*/
			public String getWenjianYesnoValue() {
				return wenjianYesnoValue;
			}
			/**
			* 设置： 文件审批状态的值
			*/
			public void setWenjianYesnoValue(String wenjianYesnoValue) {
				this.wenjianYesnoValue = wenjianYesnoValue;
			}
