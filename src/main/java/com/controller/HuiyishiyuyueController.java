    ...
    */
    ...
    public R save(@RequestBody HuiyishiyuyueEntity huiyishiyuyue, HttpServletRequest request){
        ...
        Wrapper<HuiyishiyuyueEntity> queryWrapper = new EntityWrapper<HuiyishiyuyueEntity>()
            ...
            .eq("huiyishiyuyue_yesno_types", huiyishiyuyue.getHuiyishiyuyueYesnoTypes())
            ;
...
//                            huiyishiyuyueEntity.setYonghuId(Integer.valueOf(data.get(0)));   //员工 要改的
//                            huiyishiyuyueEntity.setHuiyishiyuyueYesnoTypes(Integer.valueOf(data.get(0)));   //预约状态 要改的
