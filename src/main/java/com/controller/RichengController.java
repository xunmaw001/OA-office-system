...
//                            richengEntity.setYonghuId(Integer.valueOf(data.get(0)));   //员工 要改的
//                            richengEntity.setRichengRicheng(data.get(0));                    //日程标题 要改的
//                            richengEntity.setRichengTypes(Integer.valueOf(data.get(0)));   //日程类型 要改的
//                            richengEntity.setRichengTime(new Date(data.get(0)));          //日期 要改的
//                            richengEntity.setRichengText(data.get(0));                    //日程信息备注 要改的
//                            richengEntity.setRichengContent("");//照片
