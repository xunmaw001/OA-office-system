    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="上班考勤时间" prop="onTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.onTime" label="上班考勤时间" prop="onTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="下班考勤时间" prop="downTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.downTime" label="下班考勤时间" prop="downTime">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="考勤类型" prop="kaoqinTypes">
                        <el-select v-model="ruleForm.kaoqinTypes" :disabled="ro.kaoqinTypes" placeholder="请选择考勤类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="考勤类型" prop="kaoqinValue">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   onTime: [
                              { required: true, message: '上班考勤时间不能为空', trigger: 'blur' },
                          ],
                   downTime: [
                              { required: true, message: '下班考勤时间不能为空', trigger: 'blur' },
                          ],
                   kaoqinTypes: [
