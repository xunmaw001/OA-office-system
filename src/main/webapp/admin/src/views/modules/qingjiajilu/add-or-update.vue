    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假原因" prop="qingjiajiluName">
                       <el-input v-model="ruleForm.qingjiajiluName"
                                 placeholder="请假原因" clearable  :readonly="ro.qingjiajiluName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="请假原因" prop="qingjiajiluName">
                           <el-input v-model="ruleForm.qingjiajiluName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="请假结果" prop="qingjiajiluTypes">
                        <el-select v-model="ruleForm.qingjiajiluTypes" :disabled="ro.qingjiajiluTypes" placeholder="请选择请假结果">
                            <el-option
                                v-for="(item,index) in qingjiajiluTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="请假结果" prop="qingjiajiluValue">
                        <el-input v-model="ruleForm.qingjiajiluValue"
                            placeholder="请假结果" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="请假时间" prop="richengTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.richengTime" label="请假时间" prop="richengTime">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    qingjiajiluName: false,
                    qingjiajiluTypes: false,
                    richengTime: false,
                },
                ruleForm: {
                    yonghuId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=qingjiajilu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.qingjiajiluTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`qingjiajilu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.qingjiajiluCrossAddOrUpdateFlag = false;
                                        this.parent.search();
